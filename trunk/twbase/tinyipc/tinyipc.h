...
struct IIpcLink
{
    ...
    virtual unsigned int remoteIdentity() const = 0;
...
TW_BASE_API IIpcCenter*   getIpcCenter();
TW_BASE_API IIpcCenter*  createIpcCenter();
TW_BASE_API void destroyIpcCenter(IIpcCenter*);
TW_BASE_API IIpcHostCenter*  createIpcHostCenter();
TW_BASE_API void destroyIpcHostCenter(IIpcHostCenter*);